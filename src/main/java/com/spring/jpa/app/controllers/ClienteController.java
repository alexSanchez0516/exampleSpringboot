...
import com.spring.jpa.app.models.service.IUploadFileService;
...
public class ClienteController {
	...
	public ResponseEntity<Resource> verFoto(@PathVariable String filename,HttpServletResponse response) {
